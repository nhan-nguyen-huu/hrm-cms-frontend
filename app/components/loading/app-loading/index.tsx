  ...
  return (
    <section className='fixed inset-0 z-9999 flex items-center justify-center bg-background'>
      <section className='relative flex size-30 items-center justify-center'>
        <span className={clsx('absolute size-25 border-[3px] border-primary/40', styles['boxOne'])} />
        <span className={clsx('absolute size-30 border-8 border-primary/40', styles['boxTwo'])} />
