...
function FieldLabel({ className, required, ...props }: IFieldLabelProps) {
  return (
    <Label
      ...
      className={cn(
        ...
        'text-app-primay text-xs group-data-[invalid=true]/field:text-destructive gap-1',
        className
      )}
      {...props}
    >
      {props?.children}
      {required && <p className='text-destructive self-stretch'>*</p>}
    </Label>
  )
}
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn('text-sm font-normal text-destructive', 'text-xs', className)}
      {...props}
    >
      {content}
    </div>
